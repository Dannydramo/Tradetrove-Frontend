...
import { ResetPasswordProps } from '@/app/interface/onboarding';
import * as Yup from 'yup';
import { toast } from 'sonner';
import { resetPasswordValidationSchema } from '@/app/validators/onboarding';
import { useRouter } from 'next/navigation';
import { Label } from '@/components/ui/label';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { resetPassword } from '@/app/service/onboarding';
    ...
    return (
        <div className="w-80 sm:min-w-[450px]">
            ...
            <form onSubmit={handleSubmit}>
                <div className="grid w-full items-center my-6 gap-1.5">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex">
                            <Input
                                type={
                                    confirmTogglePassword ? 'text' : 'password'
                                }
                ...
                <Button
                    type="submit"
                    className="w-full h-12 bg-[#4F80E1] hover:bg-[#4F80E1] hover:text-white text-white"
                    disabled={isLoading}
                >
                    {isLoading ? (
                        <svg
